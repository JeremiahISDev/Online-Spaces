			...
			<nav class="bg-white dark:bg-gray-800  shadow ">
				<div class="max-w-7xl mx-auto px-8">
					<div class="flex items-center justify-between h-16">
						<div class="w-full justify-between flex items-center">
							...
							<div class="hidden md:block">
								<div class="ml-10 flex items-baseline space-x-4">
									...
									<a class="text-gray-800  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium" href="/try">
						...
						<div class="-mr-2 flex md:hidden">
							<button class="text-gray-800 dark:text-white hover:text-gray-800 inline-flex items-center justify-center p-2 rounded-md focus:outline-none">
				...
				<div class="md:hidden">
					<div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
						<a class="text-gray-800 hover:text-gray-800 dark:hover:text-white block px-3 py-2 rounded-md text-base font-medium" href="/">
							Home
                </a>
